	...
	return (
		...
		<SEO title="Clocker FAQ" />
			<div>
				...
				<p> After which, you should navigate to Clocker Preferences by clicking the menubar icon and tapping on the gear button in the lower-left corner of the Clocker Window. Preferences can be accessed using the keyboard shortcut: <b>Command + ,</b> </p>
