	...
	return (
		<Layout location={location} title={siteTitle} navigation="/">
            ...
            <div className="subpage">
                ...
                <ul>
            	<li> 
            		<a href="https://github.com/n0shake/Clocker">Clocker</a> is a menu bar utility to keep track of your friends in different time zones. <b>App Store's Editor Choice. 415K+ downloads.</b>
            	</li>
            	<li> 
